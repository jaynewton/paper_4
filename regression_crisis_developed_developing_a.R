...
da_crisis <- merge(da_crisis,da_government_yoy_a,by=c("country","ym"))
da_crisis[,pre_crisis_1_4:=pre_crisis_1+pre_crisis_2+pre_crisis_3+pre_crisis_4]
...
da_crisis <- da_crisis[country %in% developed,]
#write.csv(da_crisis,file="C:/Users/Ding/Desktop/da_crisis_developed_1_a.csv",row.names=F)
#da_crisis <- da_crisis[!country %in% developed,]
#write.csv(da_crisis,file="C:/Users/Ding/Desktop/da_crisis_developed_1_a.csv",row.names=F)
...
da_crisis <- da_crisis[country %in% developed,]
#write.csv(da_crisis,file="C:/Users/Ding/Desktop/da_crisis_developed_2_a.csv",row.names=F)
#da_crisis <- da_crisis[!country %in% developed,]
#write.csv(da_crisis,file="C:/Users/Ding/Desktop/da_crisis_developing_2_a.csv",row.names=F)
...
da_crisis <- da_crisis[country %in% developed,]
#write.csv(da_crisis,file="C:/Users/Ding/Desktop/da_crisis_developed_3_a.csv",row.names=F)
#da_crisis <- da_crisis[!country %in% developed,]
#write.csv(da_crisis,file="C:/Users/Ding/Desktop/da_crisis_developing_3_a.csv",row.names=F)
...
da_crisis <- da_crisis[country %in% developed,]
#write.csv(da_crisis,file="C:/Users/Ding/Desktop/da_crisis_developed_4_a.csv",row.names=F)
#da_crisis <- da_crisis[!country %in% developed,]
#write.csv(da_crisis,file="C:/Users/Ding/Desktop/da_crisis_developing_4_a.csv",row.names=F)
