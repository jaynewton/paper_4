...
model_1 <- plm(pre_crisis_1_3 ~ non_finance_yoy,data=da_crisis,
...
model_1 <- plm(pre_crisis_1_3 ~ household_yoy+corporation_yoy+government_yoy,
...
model_1 <- plm(pre_crisis_1_3 ~ house_yoy+stock_yoy,
               data=da_crisis,model="within",effect="individual",index=c("country","ym"))
#summary(model_1)
summary(model_1)$coefficients
...
model_1 <- plm(pre_crisis_1_3 ~ household_yoy+house_yoy+stock_yoy,
               data=da_crisis,model="within",effect="individual",index=c("country","ym"))
#summary(model_1)
summary(model_1)$coefficients

model_2 <- plm(pre_crisis_1_3 ~ household_yoy+house_yoy+stock_yoy+
...
model_1 <- plm(pre_crisis_1_3 ~ household_yoy+bubble_house+bubble_stock,
               data=da_crisis,model="within",effect="individual",index=c("country","ym"))
#summary(model_1)
summary(model_1)$coefficients

model_2 <- plm(pre_crisis_1_3 ~ household_yoy+bubble_house+bubble_stock+
